...
- (void)navigationController:(UINavigationController *)navigationController didShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    ((BaseViewController *)currentVC).shadowView.alpha = shadowViewAlphaValue;
    ...
    if (count > 1) {
        ...
        ((BaseViewController *)preVC).shadowView.alpha = shadowViewAlphaValue;
        ((BaseViewController *)currentVC).shadowView.hidden = YES;
    }
...
- (void)layoutCurrentViewWithOffset:(UIOffset)offset
{
    ...
    if (count > 1) {
        ...
        ((BaseViewController *)preVC).shadowView.alpha = shadowViewAlphaValue * currentOffsetPercent;
