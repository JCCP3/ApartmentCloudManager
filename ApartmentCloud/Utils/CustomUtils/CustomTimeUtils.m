...
{
    NSDate *dateA = [[DateFormatUtils sharedInstance].secondDateFormatter dateFromString:oneDayStr];
    NSDate *dateB = [[DateFormatUtils sharedInstance].secondDateFormatter dateFromString:anotherDayStr];
